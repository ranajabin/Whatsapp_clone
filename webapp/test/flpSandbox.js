		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#assistedinput1assistedinputproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"assistedinput1assistedinputproject1-display": {
								"semanticObject": "assistedinput1assistedinputproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=assistedinput1.assistedinputproject1",
									"url": sap.ui.require.toUrl("assistedinput1/assistedinputproject1")
								}
							}
						}
					}
